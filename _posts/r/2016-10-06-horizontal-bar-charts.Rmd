...
```{r, echo=FALSE}
plotly_POST(filename="horizontalbar/basic")
```
...
```{r, echo=FALSE}
plotly_POST(filename="horizontalbar/colored")
```
...
```{r, echo=FALSE}
plotly_POST(filename="horizontalbar/palette")
```
...
```{r, echo=FALSE}
plotly_POST(filename="horizontalbar/subplots")
```
