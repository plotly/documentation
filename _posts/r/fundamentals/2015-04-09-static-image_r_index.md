...
Another option is to do image export through your plotly account. This will export the image on plotly's servers and write the content to a local file `"output.png"` in your working directory. 

First, you will require the development version of plotly, this can be installed using `devtool::install_github("ropensci/plotly")`. In addition, if you haven't already, let the R package know about your credentials.
