...
```
## Error in fromJSON(paste(readLines(json_file), collapse = "")): could not find function "fromJSON"
```
...
```
## Error in plot_ly(type = "sankey", domain = list(x = c(0, 1), y = c(0, : object 'json_data' not found
```
...
# Create a shareable link to your chart
# Set up API credentials: https://plot.ly/r/getting-started
chart_link = api_create(p, filename="node-position")
chart_link
```

<iframe src="https://plot.ly/~RPlotBot/5943.embed" width="800" height="600" id="igraph" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
