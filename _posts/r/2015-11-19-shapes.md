...
##### For more information on using shapes check out our <b>[reference page](https://plot.ly/r/reference/#layout-shapes)</b>
...
p
```
<iframe height="600" id="igraph" scrolling="no" seamless="seamless" src="https://plot.ly/~RPlotBot/2761.embed" width="800" frameBorder="0"></iframe>
### Circles
...
d
```
<iframe height="600" id="igraph" scrolling="no" seamless="seamless" src="https://plot.ly/~RPlotBot/2763.embed" width="800" frameBorder="0"></iframe>
