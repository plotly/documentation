...
```{r, echo=FALSE}
plotly_POST(filename="line/basic")
```
...
```{r, echo=FALSE}
plotly_POST(filename="line/mode1")
```
...
```{r, echo=FALSE}
plotly_POST(filename="line/style")
```
...
```{r, echo=FALSE}
plotly_POST(filename="scatter/linetype")
```
...
```{r, echo=FALSE}
plotly_POST(filename="line/gaps")
```
...
```{r, echo=FALSE}
plotly_POST(filename="line/interp")
```
...
```{r, echo=FALSE}
plotly_POST(filename="line/annotations")
```
...
```{r, echo=FALSE}
plotly_POST(filename="line/filled")
```
