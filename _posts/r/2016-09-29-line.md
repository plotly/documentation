...
## 8:          xaxis = list(title = 'Dose in milligrams/day'),
## 9:          yaxis = list (title = 'Tooth length')
##   ^
```

<iframe src="https://plot.ly/~RPlotBot/3547.embed" width="800" height="600" id="igraph" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
...
<iframe src="https://plot.ly/~RPlotBot/3549.embed" width="800" height="600" id="igraph" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
